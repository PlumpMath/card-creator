...
main_set = {
	...
	'cards': [
			...
			{'name': "Catch Up", 			'pic': "catch_up", 			'body': "The player with the least points (if any) gains 5 points.", 'body_width': 24, 'speed': "1", 'count': 2},
			# cards 5 - 9
			...
			{'name': "Slow Magic",			'pic': "slow_magic",		'body': "The next card you use will become unused after its effect has been performed.", 'body_width': 22, 'speed': "3", 'count': 1},
			{'name': "Poke",				'pic': "poke",	 			'body': "Perform the effect of a card that your opponent controlls.", 'body_width': 22, 'speed': "2", 'count': 2},
