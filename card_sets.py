...
main_set = {
	...
	'cards': [
			{'name': "Big Time", 			'illustration': "big_time", 'body': "Gain 3 points.", 'body_width': 25, 'corner_nr': "0", }, 
			{'name': "Destruction", 		'illustration': "destruction", 'body': "Trash a card.", 'body_width': 25, 'corner_nr': "0", },
			{'name': "Ambush!", 			'illustration': "ambush", 'body': "Put a card from your hand into play face up.", 'body_width': 23, 'corner_nr': "2",},
			...
			{'name': "Late Bloomer", 		'illustration': "late_bloomer", 'body': "Gain 1 point. Turn a card into a cheat.", 'body_width': 25, 'corner_nr': "1", 'count': 5},
