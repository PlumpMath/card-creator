...
main_set = {
	...
	'cards': [
			...
			{'name': "Hecatomb", 			'pic': "hecatomb", 			'body': "Trash any number of cards you control to gain that many points.", 'body_width': 24, 'speed': "1", 'count': 1},
			{'name': "Catch Up", 			'pic': "catch_up", 			'body': "The player with the least points (if any) gains 5 points.", 'body_width': 24, 'speed': "1", 'count': 1},
			# cards 5 - 9
			...
			{'name': "Pain",				'pic': "jellyfish", 		'body': "Lose 2 poins. Make a card used or unused.", 'body_width': 24, 'speed': "2", 'count': 1},
			...
			{'name': "Poke",				'pic': "poke",	 			'body': "Perform the effect of a card that your opponent controlls.", 'body_width': 22, 'speed': "0", 'count': 1},
			# cards 35 - 39
			{'name': "Beasts",				'pic': "bison", 			'body': "Destroy the card with the highest speed. You choose which one in the case of a tie.", 'body_width': 24, 'speed': "2", 'count': 1},
			...
			{'name': "Art", 				'pic': "bike2", 			'body': "Lose 1 point. You may make this card unused.", 'body_width': 25, 'speed': "1", 'count': 1},
			{'name': "Permutations",		'pic': "creatures", 		'body': "Play up to three face up cards. Make them used.", 'body_width': 25, 'speed': "2", 'count': 1},
			# cards 40 - 44
			{'name': "Bad Omen",			'pic': "bird", 		'body': "Lose all your points. Make all your cheats unused.", 'body_width': 25, 'speed': "0", 'count': 1},
